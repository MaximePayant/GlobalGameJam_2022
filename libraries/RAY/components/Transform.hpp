...
#ifndef __RAYLIB_MODULE_TRANSFORM_HPP__
#define __RAYLIB_MODULE_TRANSFORM_HPP__
...
namespace ray
{
    ...
    private:
        ray::Vector3f m_position;
        ray::Vector3f m_globalPosition;
        ray::Vector3f m_scale;
        ray::Vector3f m_globalScale;
        float m_angle;
        ray::Vector3f m_rotation;
        ray::Vector3f m_globalRotation;
    ...
    public:
        ...
        //
        void setPosition(const ray::Vector3f& position);
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Set the position of a Transform Component.
        ...
        //
        void move(const ray::Vector3f& position);
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Move a Transform Component.
        ...
        //
        const ray::Vector3f& getPosition() const;
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Get the globale position of a Transform Component.
        //
        const ray::Vector3f& getGlobalPosition() const;
        //
        ///////////////////////////////////////////////////////////////////
        ...
        //
        void setScale(const ray::Vector3f& scale);
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Set the scalation of a Transform Component.
        ...
        //
        void scale(const ray::Vector3f& scale);
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Scale the Transform Component.
        ...
        //
        const ray::Vector3f& getScale() const;
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Get the global scalation of a Transform Component.
        //
        const ray::Vector3f& getGlobalScale() const;
        //
        ///////////////////////////////////////////////////////////////////
        ...
        //
        ray::Vector3f getRotation() const;
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Get the orientation of the Transform Component in degree.
        ...
        //
        const ray::Vector3f getTransformPoint(const ray::Vector3f& point) const;
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Return the position of the given point, transform by
        ...
        //
        const ray::Vector3f getTransformPoint(float x, float y, float z = 1) const;
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Return the position of the given point, transform by
        ...
        /// @param point The point to transform.
        //
        const ray::Vector3f getGlobalTransformPoint(const ray::Vector3f& point) const;
        //
        ///////////////////////////////////////////////////////////////////
        ///
        /// Return the position of the given point, transform by
        ...
        /// @param y Y coordinate of the point to transform.
        //
        const ray::Vector3f getGlobalTransformPoint(float x, float y, float z = 1) const;
        //
        ///////////////////////////////////////////////////////////////////
...
#endif //__RAYLIB_MODULE_TRANSFORM_HPP__
