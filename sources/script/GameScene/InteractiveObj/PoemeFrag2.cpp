...
PoemeFrag2::PoemeFrag2(sw::Entity& entity)
    :   InteractiveObj{entity}
{
    m_entity.scene().eventManager()["Start"].subscribe(this, &PoemeFrag2::start);
    m_entity.scene().eventManager()["Update"].subscribe(this, &PoemeFrag2::update);
}

void PoemeFrag2::start()
{
    ...
    model.setModel("PoemeFrag2");
    model.setTexture("Note1Base", 0);
}

void PoemeFrag2::update()
{}